...
export default function Card(props) {
    ...
    return (
        <div className="card h-80 w-54 sm:w-72 xs:px-0 word-break mx-auto bg-white rounded-xl shadow-xl flex flex-col /relative cursor-pointer"
        >
            <div className="card-front mr-3 pt-3 cursor-pointer flex justify-end"
                onClick={() => !props.word.saved ? saveWord(props.word) : removeWord(props.word)}
            >
                {props.word.saved ?
                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M26.5714 10H14.4286C13.7845 10 13.1668 10.2341 12.7113 10.6509C12.2559 11.0676 12 11.6329 12 12.2222V30L20.5 26.6667L29 30V12.2222C29 11.6329 28.7441 11.0676 28.2887 10.6509C27.8332 10.2341 27.2155 10 26.5714 10Z" fill="white" />
                    </svg>
                    :
                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="20" cy="20" r="20" fill="#9CBACE" />
            ...
            <div className="cardback px-2 -mt-3 h-full flex justify-center items-center"
            ...
            >
                {props.loading ?
                    ...
                    (
                        props.translate ?
                            <p className="text-card">{props.word.th}</p>
                            :
                            <p className="text-card">{props.word.en}</p>
                    )
                }
            </div>
        </div>
